...
#define DEBUG_SMTPCLIENT_PRINTF(...) DEBUG_ESP_PORT.printf( __VA_ARGS__ )
#define DEBUG_SMTPCLIENT_PRINT(...) DEBUG_ESP_PORT.print( __VA_ARGS__ )
#define DEBUG_SMTPCLIENT_PRINTLN(...) DEBUG_ESP_PORT.println( __VA_ARGS__ )
#endif
#else
#define DEBUG_SMTPCLIENT_PRINTF(...)
#define DEBUG_SMTPCLIENT_PRINT(...)
#define DEBUG_SMTPCLIENT_PRINTLN(...)
#endif
