...
#define WIFI_MANAGER_MAX_PARAMS 22
...
class WiFiManager
{
  public:
    ...
    void          setRemoveDuplicateAPs(boolean removeDuplicates);
        //called when reset is selected in AP portal
    void          setResetCallback( void (*func)(void) );
    //sets STA config not relying on SSID and PASS saved in WiFi EEPROM internally, allowing WiFi.persistent( false );
    String        getSSID();
    String        getPassword();
